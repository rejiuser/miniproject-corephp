...
session_start();
$user=$_SESSION['id'];
$query="select request_tb.id as rid,request_tb.*,books_tb.* from request_tb inner join books_tb on request_tb.book_id=books_tb.id where request_tb.status='Approved' and request_tb.student_id='$user'";
...
<li class="active"><a href="approvedrequest.php"><i class="fa fa-circle-o"></i>Approved Request</a></li>
...
while($row=mysqli_fetch_array($re))
{
    ...
    <td><a href="approveddetails.php?id=<?php echo $row['rid'];?>" class="btn btn-primary">Details</a></td>
