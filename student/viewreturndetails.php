...
$query="select return_tb.id as rid,return_tb.*,request_tb.*,books_tb.* from return_tb inner join request_tb on return_tb.request_id=request_tb.id inner join books_tb on books_tb.id=request_tb.book_id where return_tb.id=$id";
