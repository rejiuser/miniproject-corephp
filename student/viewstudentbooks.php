...
$query="select books_tb.id as bid,books_tb.*,category_tb.* from books_tb inner join category_tb on books_tb.Category=category_tb.id";
...
<li class="active"><a href="viewstudentbooks.php"><i class="fa fa-circle-o"></i> View Books</a></li>
...
while($row=mysqli_fetch_array($re))
{
    ...
    <td><a href="bookdetails.php?id=<?php echo $row['bid'];?>" class="btn btn-info">DETAILS</a></td>
