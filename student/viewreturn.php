...
session_start();
$user=$_SESSION['id'];
$query="select return_tb.id as rid,return_tb.*,request_tb.*,books_tb.* from return_tb inner join request_tb on return_tb.request_id=request_tb.id inner join books_tb on request_tb.book_id=books_tb.id where request_tb.student_id='$user' GROUP BY request_tb.id";
...
<li  class="active"><a href="viewreturn.php"><i class="fa fa-circle-o"></i>View Return</a></li>
...
while($row=mysqli_fetch_array($re))
{
    ...
    <tr>
        ...
        <td><a href="viewreturndetails.php?id=<?php echo $row['rid'];?>" class="btn btn-primary">DETAILS</a></td>
