...
session_start();
$id=$_GET['id'];
$query="select * from books_tb where id=$id";
...
<div class="col-md-3 text-center">
      ...
      <div class="col-md-3 text-center">
        ...
        <div class="col-md-3 text-center">
        <img src="../images/<?php echo $row['Photo'];?>" height="50" widht="50">
      </div>
        </div> 
        <div class="row">
          <div class="col-md-6 text-center ">
          <input type="submit" name="sub" value="Request" class="btn btn-success ">
        </div>
        </div>
