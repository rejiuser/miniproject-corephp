<?php
include('changepasswordupdates.php');
session_start();
?>
<html>
      ...
      <form role="form">
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"  name="cu" >
                  <?php
                  if($cerr!=1)
{
    echo $cerr;
...
<form action="booksinsertform.php" method="post" enctype="multipart/form-data">
    ...
    <!-- <div class="box-body">
              ...
              <table>
                <form role="form">
                  <div class="form-group">
<label>Current Password</label><input type="text" name="cu" class="form-control"> --> 
<?php

?>
</div>
<div class="form-group">
<!-- <label>New Password</label><input type="text" name="new" class="form-control"> -->

</div>
<div class="form-group">
<!-- <label>Confirm Password</label><input type="text" name="conf" class="form-control"> -->
