...
$user=$_SESSION['id'];
$query="select * from student_reg_tb where id='$user'";
...
<form action="updateform.php?id=<?php echo $row['id'];?>" method="post" enctype="multipart/form-data">
<!-- Main content -->
...
<input type="text" name="age" class="form-control" value="<?php echo $row['Age'];?>">
  ...
  <div class="form-group">
<label>Address</label>
<textarea name="add" class="form-control" value=""><?php echo $row['Address'];?></textarea>
  </div>
  <div class="form-group">
<label>Email</label>
...
<input type="file" class="form-control" name="photo" value="<?php echo $row['photo'];?>">
  ...
  <div class="form-group">
<label>Username</label><input type="text" class="form-control" name="user" value="<?php echo $row['Username'];?>" readonly>
  </div>
