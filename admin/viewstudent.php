...
$query="select * from student_reg_tb";
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>RE</b>JI</span>
      <!-- logo for regular state and mobile devices -->
      <span class="logo-lg"><b>MINIPROJECT</b></span>
    </a>
...
while($row=mysqli_fetch_array($re))
{
    ...
    <td>
        ...
        {
            ?>
            <a href="approve.php?id=<?php echo $row['id'];?>" class="btn btn-info">>Approve</a>
            <?php 
        ...
        {
            ?>
        <p class="btn btn-info">Approved</p>
            <?php 
    ...
    {
        ?>
         <a href="reject.php?id=<?php echo $row['id'];?>" class="btn btn-warning">Reject</a>
         <?php
    }
    ?>
    <?php
