...
while($row=mysqli_fetch_array($re))
{
    ...
    <td><a href="editbook.php?id=<?php echo $row['bid'];?>" class="btn btn-success">EDIT</a></td>
    <td><a href="deletebook.php?id=<?php echo $row['bid'];?>" class="btn btn-danger">DELETE</a></td>
</tr>
<?php
}
?>
