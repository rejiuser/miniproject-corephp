...
$id=$_GET['id'];
$query="select request_tb.id as rid,books_tb.*,request_tb.*,student_reg_tb.* from request_tb inner join books_tb on request_tb.book_id=books_tb.id inner join student_reg_tb on request_tb.student_id=student_reg_tb.id where request_tb.id=$id";
...
<div class="content-wrapper">
    ...
    <div class="col-md-8 ">
          ...
          <div class="row">
            ...
            <th>STUDENT DETAILS</th></thead>
  </div></div>
  <div class="col mt-5">
           <div class="row ">
  <div class="col-md-5 text-center">  <label>NAME :</label></div>
    <div class="col">
    <?php echo $row['Name'];?>
  </div>
  </div>
  ...
  <div class="row">
    <div class="col">
<a href="requestapprove.php?id=<?php echo $id;?>" class="text-success fw-bold fs-1">Approve</a>
</div>
<div class="col">
<a href="requestreject.php?id=<?php echo $id;?>" class="text-danger fw-bold">Reject</a>
</div>
  </div>
